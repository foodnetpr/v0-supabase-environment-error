          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                <a href="https://v0-supabase-environment-error-ruddy.vercel.app" className="text-rose-600 hover:underline">
                  https://v0-supabase-environment-error-ruddy.vercel.app
                </a>
