    ...
    <div className="flex flex-col min-h-screen bg-white font-sans">
      ...
      {restaurants.length > 0 && (
        <section id="restaurantes" className="pt-4 sm:pt-6 pb-12 sm:pb-16">
          <div className="w-full px-3 lg:mx-auto lg:max-w-7xl lg:px-4">
      ...
      {filteredRestaurants.length === 0 && restaurants.length > 0 && (
        <div className="w-full px-3 lg:mx-auto lg:max-w-7xl lg:px-4 py-12 sm:py-20 text-center">
...
function MarketplaceFooter() {
  return (
    <footer className="border-t border-slate-200 bg-white py-6 sm:py-8 mt-auto">
      <div className="w-full flex flex-col items-center justify-between gap-3 sm:gap-4 px-3 lg:mx-auto lg:max-w-7xl lg:px-4 sm:flex-row">
        <Image
